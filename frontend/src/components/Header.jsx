...
const Header = () => {
  ...
  return (
    <>
      <CommandK isOpen={showCommandK} onClose={() => setShowCommandK(false)} />
      <header>
        <nav className="navbar">
          ...
          <div className="nav-actions">
            <button className="icon-btn hover-lift" title="Search (Ctrl+K)" onClick={() => setShowCommandK(true)}>
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                <circle cx="11" cy="11" r="8"></circle>
                <line x1="21" y1="21" x2="16.65" y2="16.65"></line>
              </svg>
            </button>
            <button className="icon-btn hover-lift" title="Notifications">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                <path d="M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9"></path>
                <path d="M13.73 21a2 2 0 0 1-3.46 0"></path>
              </svg>
            </button>
            <Link to="/bookmarks" className="icon-btn hover-lift" title="Bookmarks">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
            ...
            {user ? (
              <div className="profile-section" ref={profileMenuRef}>
                <button
                  className="nav-avatar hover-lift"
                ...
                {showProfileMenu && (
                  <div className="profile-dropdown glass-card">
                    ...
                    <div className="profile-menu">
                      <Link to="/settings" onClick={() => setShowProfileMenu(false)} className="hover-lift">
                      ...
                      {isAdmin() && (
                        <Link to="/admin" onClick={() => setShowProfileMenu(false)} className="hover-lift">
                          <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                      ...
                      <button onClick={handleLogout} className="hover-lift">
                        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
              ...
              <Link
                to="/signin"
                className="btn-login hover-lift"
